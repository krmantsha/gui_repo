...
if [ "$2" = "1" ]; then
	...
	echo " $1" | sed 's/,/, ,/g'   | festival --tts;
       /home/rt/seiscomp/share/scalert/gm_hl.sh $3 > emaiInfo.txt
       /home/rt/seiscomp/bin/seiscomp exec scbulletin -d mysql://sysop:sysop@localhost/seiscomp3_cgs2 -E $3 >> emaiInfo.txt
